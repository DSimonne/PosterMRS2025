...
\begin{column}{\colwidth}
    ...
    \begin{block}{\textit{In situ} electrochemical cell}
        \heading{The cell design must be compatible with each synchrotron beamline's unique setup.}

        \begin{figure}
            \centering
            % \includegraphics[width=0.9\colwidth]{/ElectrochemicalCell/Fig_ABCD.pdf}
            \includegraphics[height=11cm]{ElectrochemicalCell/3DView1.jpg}
            \includegraphics[height=11cm]{ElectrochemicalCell/3DView2.jpg}
